...
export const fetchProducts = createAppAsyncThunk<
  TProductsResponseDto & { currentUser: TUserResponseDto | null },
  void
>(
...
export const fetchChangeLikeProduct = createAppAsyncThunk<
  { product: TProductResponseDto; liked: boolean },
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchProducts.pending, (state) => {
        // { type: products/fetchProducts/pending, payload: {...}}
        state.loading = true;
        state.error = null;
      })
